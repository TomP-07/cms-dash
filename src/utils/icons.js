...
export const MaterioLogo = props => {
  return (
    <svg width={30} height={25} viewBox="0 0 30 23" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g transform="translate(-95 -51) translate(95 50)" fill="none" fillRule="evenodd">
        <path
          fill="#9155FD"
        ...
        />
        <path opacity={0.077704} fill="#000" d="M0 8.58870968L7.25806452 12.7505183 7.25806452 16.8305646z" />
        <path opacity={0.077704} fill="#000" d="M0 8.58870968L7.25806452 12.6445567 7.25806452 15.1370162z" />
        <path
          opacity={0.077704}
          fill="#000"
        ...
        />
        <path fillOpacity={0.15} fill="#FFF" d="M3.045 1.866L15 9.194v7.983L0 8.587V3.571a2 2 0 013.045-1.706z" />
        <path
          fillOpacity={0.35}
          fill="#FFF"
